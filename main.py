...
import time
import os
os.system("title Bubble Terminal")
import glob
import pyfiglet
import sys
import keyboard
...
ascii_banner = pyfiglet.figlet_format("BUBBLE")
print(ascii_banner)

print("Bubble Hacker Terminal [Version 1.0]")
print("------------------------------------")
...
while True:
    ...
    if cmd == "":
        ...
        if arg == "-ping":
            ...
            path = r'C:\Programme\Bubble\Terminal\usg\ddos.py'
        ...
        if usg == "-i":
            ...
            if help_to == "netsh":
                ...
                print("Server help")
                print("Has server tools")
                print("Arguments for server")
                print('     "-start" starts a server')
                print('          \ + [file_name]')
                print('     "-stop" stops servers when started')
                print('     "-list" shows avalibal servers to start')
                print('\n')

            elif help_to == "dir":
                print('Dir help')
                print('Dir changes ore shows cwdir')
                ...
                print("Title help")
                print("Changes the title of the Termianlwindow")
                ...
                print("Start help")
                print("Start will start a given Programm ore addres")
                ...
                print("Cmd help")
                print("Start cmd termianl ore execute cmd commands")
                ...
                print("No help for '" + help_to + "' found")
            ...
            print('     "server" start/stop servers')
            print('     "vol" shows details about windows HHD')
            ...
            print('     "start" start program ore webpage')
            ...
            print('\n')
            print('For help on a sertain command type:')
        ...
        arg = cmd[7:13]
        if arg == "-start":
            server_to_start = cmd[14:]
            try:
                installed_dir = r"C:\Programme\Bubble\Terminal\server" + server_to_start
                os.system("python " + installed_dir)
            except:
                print("Error:")
                print("This file could not been started")

        elif arg == "-stop":
            time.sleep(1)
            print("Stopped servers")
        elif arg == "-list":
            os.system("dir C:\Programme\Bubble\Terminal\server")

        else:
            print("Self.args Error:")
            print('No arg "' + arg + '" was found')
        ...
        if arg == "-i":
            ...
            print("Arg not found ore not given")
